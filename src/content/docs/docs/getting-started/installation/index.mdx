...
<Tabs>
	<TabItem label="Linode (Akamai)">
		...
		<LinkCard title="Linode AzuraCast One-Click Image" href="https://www.linode.com/marketplace/apps/linode/azuracast/" target="_blank" />
	</TabItem>
	<TabItem label="Vultr">
	...
	<TabItem label="DigitalOcean">
		...
		<LinkCard title="DigitalOcean AzuraCast One-Click Image" href="https://marketplace.digitalocean.com/apps/azuracast" target="_blank" />
	</TabItem>
</Tabs>
